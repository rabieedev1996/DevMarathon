...
public class IdentityUtility
{
    ...
    public static string GenerateToken(TokenParams TokenParams,TokenConfigs TokenConfig)
    {
        //https://8gwifi.org/jwsgen.jsp (key generator:HS256)
        string key = TokenConfig.Key;
        ...
        var credentials = new SigningCredentials(securityKey, TokenConfig.SecurityAlgorithm);
